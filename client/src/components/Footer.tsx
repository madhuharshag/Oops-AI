...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-slate-800/80 bg-[#07090e] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-6 text-xs text-slate-400 font-medium">
          <Link to="/about" className="hover:text-cyan-400 transition">About & Ethics</Link>
          ...
          <a href="/api/docs" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition">
            API Documentation
          </a>
          <a
