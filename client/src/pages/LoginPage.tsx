      ...
      <div className="cyber-card p-8 sm:p-10 w-full max-w-md border-cyan-500/30 bg-slate-900/90 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full mt-2 py-2.5 px-4 rounded-lg bg-cyan-500 hover:bg-cyan-400 disabled:opacity-50 text-slate-950 font-bold text-sm transition flex items-center justify-center gap-2 shadow-md shadow-cyan-500/20"
          >
        ...
        <div className="mt-6 pt-4 border-t border-slate-800 text-center">
          <button
            ...
            className="text-xs font-mono text-cyan-300 hover:text-cyan-200 flex items-center justify-center gap-1.5 mx-auto transition"
          >
